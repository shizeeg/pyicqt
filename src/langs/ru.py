...
class ru: # Russian - evadim <evadim@evadim.ru> & Night Nord <NightNord@gmail.com>
	...
	authenticatetext = u"ВНИМАНИЕ: Регистрация состоит из двух шагов.  Сначала, введите ваши локальные имя пользователя и пароль.  Если вы ввели правильное имя пользователя и пароль, вы получите сообщение 'Регистрация завершена'.  Далее, снова выберите 'Зарегистрироваться' и вы получите предложение ввести имя пользователя и пароль от вашей учётной записи AIM."
	...
	notregistered = u"Извините, не похоже что вы зарегистрированы на этом шлюзе. Пожалуйста, зарегистрируйтесь и попробуйте снова. Если у вас есть проблемы с регистрацией - обратитесь к администратору XMPP-сервера."
	...
	searchinstructions = u"Укажите e-mail адресс, или любую другую информацию в соответсвующих полей, для поиска подходящих пользователей в базе ICQ.  Если заполнено поле e-mail адреса, все другие поля игнорируются."
	command_CommandList = u"Комманды PyICQt"
	...
	command_FormatScreenName_FMTScreenName = u"Фрматированное ScreenName"
	...
	xstatus_restore_after_disconnect = u"Восстанавливать х-статус после отключения"
	...
	# message settings
	utf8_messages_sendmode = u"Посылать сообщения в utf8"
	...
	user_mood_receiving = u"Показывать настроение"
	user_activity_receiving = u"Показывать деятельность"
