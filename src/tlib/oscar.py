...
SIGNON_ERROR_CODES = dict([
	...
	(0x14, 'The instant messenger server is temporarily unavailable (reservation map error)'),
	(0x15, 'The instant messenger server is temporarily unavailable (reservation link error)'),
